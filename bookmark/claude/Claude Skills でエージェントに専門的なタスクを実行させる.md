...
source: "https://azukiazusa.dev/blog/claude-skills-custom-skills-for-claude/"
author:
  - "[[azukiazusaのテックブログ2]]"
published: 2025-10-26
created: 2025-10-30
description: "Claude Skills は Claude が特定のタスクを実行するためのカスタムスキルを作成・共有できる新しい機能です。この記事では、Claude Skills の仕組みと作成方法、MCP ツールとの違いについて解説します。"
tags:
  - "clippings"
image: "https://azukiazusa.dev/blog/ogp/claude-skills-custom-skills-for-claude.png"
---
...
![](https://images.ctfassets.net/in6v9lxmm5c8/14xQ6dSTj2jK8eDyrbgwg9/19f9fc7161069bc68cce0338aa5bb92b/%C3%A3__%C3%A3__%C3%A3_%C2%AA%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3___2025-10-26_10.55.44.png?q=50&fm=webp)

このスキルではスライドの元になる HTML ファイルを作成し、PptxGenJS ライブラリを使用して pptx ファイルを生成する JavaScript コードをサンドボックス内で実行している様子が確認できます。

![](https://images.ctfassets.net/in6v9lxmm5c8/4QieWDEVgZ5tcTJKjoUBF1/d66809aa53c8236ab5ac335fcf6773c0/%C3%A3__%C3%A3__%C3%A3_%C2%AA%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3___2025-10-26_10.59.43.png?q=50&fm=webp)
...
screenshoting-webpages-to-pdf/SKILL.md
...
screenshoting-webpages-to-pdf/examples/take-screenshot.js
...
screenshoting-webpages-to-pdf/scripts/convert-to-pdf.js
...
![](https://images.ctfassets.net/in6v9lxmm5c8/4N6U1ozPTZpzLsbc3e92pz/e5099f5e58cb474d98753ccade0bb175/%C3%A3__%C3%A3__%C3%A3_%C2%AA%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3___2025-10-26_13.03.02.png?q=50&fm=webp)

ファイルを選択するダイアログが表示されるので、先ほど作成した `screenshoting-webpages-to-pdf.zip` ファイルを選択します。

![](https://images.ctfassets.net/in6v9lxmm5c8/6uyAKcmLFHJZzZq9QTSMoj/4d42ae2f6f3a8b27df330e9f8ccdd1d6/%C3%A3__%C3%A3__%C3%A3_%C2%AA%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3___2025-10-26_13.05.20.png?q=50&fm=webp)

Skills の一覧にアップロードしたスキルが追加されていることが確認できます。トグルスイッチがオンになっている場合はスキルが有効化されている状態です。

![](https://images.ctfassets.net/in6v9lxmm5c8/7fbBpyZ6kEmkD0lABHf55E/31f26056da8d14acea03a34582d7c978/%C3%A3__%C3%A3__%C3%A3_%C2%AA%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3___2025-10-26_13.07.00.png?q=50&fm=webp)
...
![](https://images.ctfassets.net/in6v9lxmm5c8/29nQ6SlnRa0pONxPWmLcJf/b3c4a9060600a1b76552d5c7303bb2f5/%C3%A3__%C3%A3__%C3%A3_%C2%AA%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3___2025-10-26_13.10.23.png?q=50&fm=webp)
...
![](https://images.ctfassets.net/in6v9lxmm5c8/2ZYsexdvN5FW2nIdqNh5Ez/9e80db5c35f1d214849248bfa30b0a90/%C3%A3__%C3%A3__%C3%A3_%C2%AA%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3__%C3%A3___2025-10-26_13.21.15.png?q=50&fm=webp)
...
### Claude Skills において、スキルの詳細な説明が段階的に読み込まれる設計の主な目的は何ですか？

- コンテキストウィンドウの圧迫を防ぎ、Claude の性能低下を防ぐため
	正解！
	name と description フィールドがまず読み込まれ、必要な場合のみ SKILL.md の本文が読み込まれます。これにより、使用頻度の低いスキルの詳細説明がコンテキストを圧迫することを防いでいます。
- スキルのディレクトリの構造をモジュール化するため
	もう一度考えてみましょう
- セキュリティリスクを軽減するため
	もう一度考えてみましょう
- 複数のスキルを同時に実行できるようにするため
	もう一度考えてみましょう

### SKILL.md ファイルの YAML フロントマターで必須のフィールドはどれですか？

- name と description
	正解！
	name（最大64文字）と description（最大1024文字）の2つが必須フィールドです。Claude がスキルをどのタイミングで使用するかを判断するために利用されます。
- name、description、version
	もう一度考えてみましょう
	version フィールドは必須ではありません。必須なのは name と description のみです。
- name のみ
	もう一度考えてみましょう
	description フィールドも必須です。スキルの機能と使用方法を説明するために重要です。
- name、description、author
	もう一度考えてみましょう
	author フィールドは必須ではありません。必須なのは name と description のみです。